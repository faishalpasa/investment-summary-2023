...
const StoryCard = () => {
  ...
  return (
    <div className={classes.card}>
      <img src="/images/cat-1.png" alt="star1" className={classes.star1} />
      <img src="/images/cat-1.png" alt="star2" className={classes.star2} />
      <img src="/images/cat-1.png" alt="star3" className={classes.star3} />
      <img src="/images/cat-1.png" alt="star4" className={classes.star4} />
      ...
      <div className={classes.titleTwo}>
        <div className={classes.titleContent}>
          <div className={classes.imageShuffle}>
            <img src="/images/cat-2.png" alt="shuffle1" className={classes.imageShuffle1} />
          </div>
          <div className={classes.imageShuffle}>
            <img src="/images/cat-3.png" alt="shuffle2" className={classes.imageShuffle2} />
          </div>
          <div className={classes.imageShuffle}>
            <img src="/images/cat-4.png" alt="shuffle3" className={classes.imageShuffle3} />
          </div>
          <div className={classes.imageShuffle}>
            <img src="/images/cat-5.png" alt="shuffle4" className={classes.imageShuffle4} />
          </div>
      ...
      <div className={classes.titleThree}>
        <div className={classes.titleContent}>
          <img src="/images/cat-6.png" alt="result" className={classes.imageResult} />
